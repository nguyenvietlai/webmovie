			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb__links">
						<a href="Homess.php"><i class="fa fa-home"></i> Home</a> <span>All
							product</span>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<div class="product__page__content">
							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-4 col-sm-6">
									<div class="product__page__filter">
										<p>Order by:</p>
										<select onchange="filterByCate(this.value, `${status}`)">
											<option value="0">All</option>
											<c:if test="${ listCate != null}">
												<c:forEach items="${listCate}" var="cate" varStatus="loop">
													<option value="${loop.index +1}">${cate.category_name}</option>
												</c:forEach>
											</c:if>
						...
						<div class="row" id="LoadingVideoItemsResult">
							<div class="col-lg-4 col-md-6 col-sm-6">
								<div class="product__item">
									<div class="product__item__pic set-bg"
										data-setbg="https://img.youtube.com/vi/QlOOtlVw1kc/maxresdefault.jpg">
						...
						<div class="product__sidebar__view">
							...
							<div class="filter__gallery">
								...
								<div class="product__sidebar__view__item set-bg mix week years"
									data-setbg="${pageContext.request.contextPath}/Template/Users/img/sidebar/tv-3.jpg">
									<div class="ep">18 / ?</div>
									<div class="view">
										<i class="fa fa-eye"></i> 9141
									</div>
								...
								<div class="product__sidebar__view__item set-bg mix day"
									data-setbg="${pageContext.request.contextPath}/Template/Users/img/sidebar/tv-5.jpg">
									<div class="ep">18 / ?</div>
									<div class="view">
										<i class="fa fa-eye"></i> 9141
									</div>
						...
						<div class="product__sidebar__comment">
							...
							<div class="product__sidebar__comment__item">
								<div class="product__sidebar__comment__item__pic">
									<img
										src="${pageContext.request.contextPath}/Template/Users/img/sidebar/comment-1.jpg"
										alt="">
								</div>
							...
							<div class="product__sidebar__comment__item">
								<div class="product__sidebar__comment__item__pic">
									<img
										src="${pageContext.request.contextPath}/Template/Users/img/sidebar/comment-2.jpg"
										alt="">
								</div>
								<div class="product__sidebar__comment__item__text">
									<ul>
							...
							<div class="product__sidebar__comment__item">
								<div class="product__sidebar__comment__item__pic">
									<img
										src="${pageContext.request.contextPath}/Template/Users/img/sidebar/comment-3.jpg"
										alt="">
								</div>
								<div class="product__sidebar__comment__item__text">
									<ul>
							...
							<div class="product__sidebar__comment__item">
								<div class="product__sidebar__comment__item__pic">
									<img
										src="${pageContext.request.contextPath}/Template/Users/img/sidebar/comment-4.jpg"
										alt="">
								</div>
								<div class="product__sidebar__comment__item__text">
									<ul>
	...
	<script type="text/javascript">
	 if(${status == "series"}){
	    ...
	    function LoadingEpisodes() {
			let result = document.getElementById("LoadingVideoItemsResult");
			$.ajax({
				url : "LoadEpisodeMovies",
				type : 'GET',
		...
		function filterByCate(selectedValue, status){
			let value = selectedValue;
			let types = status;
			let result = document.getElementById("LoadingVideoItemsResult");
			$.ajax({
				url : "FilterVideosByCate",
				type : 'GET',
				data: {
					value : value,
					types : types
